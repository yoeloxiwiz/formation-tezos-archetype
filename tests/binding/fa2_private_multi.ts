...
export class mint_params implements att.ArchetypeType {
    constructor(public p_token_id: att.Nat, public p_owner: att.Address, public p_token_metadata: Array<[
        string,
        att.Bytes
    ]>, public p_amount: att.Nat) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.p_token_id.to_mich(), this.p_owner.to_mich(), att.list_to_mich(this.p_token_metadata, x => {
                const x_key = x[0];
                const x_value = x[1];
                return att.elt_to_mich(att.string_to_mich(x_key), x_value.to_mich());
            }), this.p_amount.to_mich()]);
    }
    equals(v: mint_params): boolean {
        return att.micheline_equals(this.to_mich(), v.to_mich());
    }
    static from_mich(input: att.Micheline): mint_params {
        return new mint_params(att.Nat.from_mich((input as att.Mpair).args[0]), att.Address.from_mich((input as att.Mpair).args[1]), att.mich_to_map((input as att.Mpair).args[2], (x, y) => [att.mich_to_string(x), att.Bytes.from_mich(y)]), att.Nat.from_mich((input as att.Mpair).args[3]));
    }
}
...
export const mint_params_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    att.prim_annot_to_mich_type("nat", ["%p_token_id"]),
    att.prim_annot_to_mich_type("address", ["%p_owner"]),
    att.pair_annot_to_mich_type("map", att.prim_annot_to_mich_type("string", []), att.prim_annot_to_mich_type("bytes", []), ["%p_token_metadata"]),
    att.prim_annot_to_mich_type("nat", ["%p_amount"])
], []);
...
export const minters_key_mich_type: att.MichelineType = att.prim_annot_to_mich_type("address", []);
...
export type minters_container = Array<att.Address>;
...
export const minters_container_mich_type: att.MichelineType = att.set_annot_to_mich_type(att.prim_annot_to_mich_type("address", []), []);
...
const add_minter_arg_to_mich = (aminter: att.Address): att.Micheline => {
    return aminter.to_mich();
}
const remove_minter_arg_to_mich = (rminter: att.Address): att.Micheline => {
    return rminter.to_mich();
}
...
const mint_arg_to_mich = (tow: att.Address, tid: att.Nat, tdata: Array<[
    string,
    att.Bytes
]>, nbt: att.Nat): att.Micheline => {
    return att.pair_to_mich([
        tow.to_mich(),
        tid.to_mich(),
...
const mint_batch_arg_to_mich = (mint_params_list: Array<mint_params>): att.Micheline => {
    return att.list_to_mich(mint_params_list, x => {
        return x.to_mich();
    });
}
...
export class Fa2_private_multi {
    ...
    async deploy(owner: att.Address, permits: att.Address, params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./contracts/fa2_private_multi.arl", {
            owner: owner.to_mich(),
    ...
    async add_minter(aminter: att.Address, params: Partial<ex.Parameters>): Promise<att.CallResult> {
        if (this.address != undefined) {
            return await ex.call(this.address, "add_minter", add_minter_arg_to_mich(aminter), params);
        }
        throw new Error("Contract not initialised");
    }
    async remove_minter(rminter: att.Address, params: Partial<ex.Parameters>): Promise<att.CallResult> {
        if (this.address != undefined) {
            return await ex.call(this.address, "remove_minter", remove_minter_arg_to_mich(rminter), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async mint(tow: att.Address, tid: att.Nat, tdata: Array<[
        string,
        att.Bytes
    ]>, nbt: att.Nat, params: Partial<ex.Parameters>): Promise<att.CallResult> {
        if (this.address != undefined) {
            return await ex.call(this.address, "mint", mint_arg_to_mich(tow, tid, tdata, nbt), params);
        }
        throw new Error("Contract not initialised");
    }
    async mint_batch(mint_params_list: Array<mint_params>, params: Partial<ex.Parameters>): Promise<att.CallResult> {
        if (this.address != undefined) {
            return await ex.call(this.address, "mint_batch", mint_batch_arg_to_mich(mint_params_list), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_add_minter_param(aminter: att.Address, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "add_minter", add_minter_arg_to_mich(aminter), params);
        }
        throw new Error("Contract not initialised");
    }
    async get_remove_minter_param(rminter: att.Address, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "remove_minter", remove_minter_arg_to_mich(rminter), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_mint_param(tow: att.Address, tid: att.Nat, tdata: Array<[
        string,
        att.Bytes
    ]>, nbt: att.Nat, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "mint", mint_arg_to_mich(tow, tid, tdata, nbt), params);
        }
        throw new Error("Contract not initialised");
    }
    async get_mint_batch_param(mint_params_list: Array<mint_params>, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "mint_batch", mint_batch_arg_to_mich(mint_params_list), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_minters(): Promise<minters_container> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.mich_to_list((storage as att.Mpair).args[8], x => { return att.Address.from_mich(x); });
        }
        throw new Error("Contract not initialised");
    }
    ...
    errors = {
        ...
        r12: att.pair_to_mich([att.string_to_mich("\"INVALID_CONDITION\""), att.string_to_mich("\"r12\"")]),
        ...
        r9: att.pair_to_mich([att.string_to_mich("\"INVALID_CONDITION\""), att.string_to_mich("\"r9\"")]),
...
export const fa2_private_multi = new Fa2_private_multi();
